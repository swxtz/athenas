                    ...
                    <Container>
                        <Section className="mt-8 px-8">
                            ...
                            <Text className="text-gray-800 mt-2">
                                Bem-vindo(a) à {ecommerceName}! Estamos felizes
                                em tê-lo(a) conosco.
                            </Text>
                            <Text className="text-gray-800 mt-2">
                                Para concluir seu cadastro e aproveitar todas as
                                vantagens de nossa plataforma, é necessário
                                verificar sua conta. Basta clicar no botão
                                abaixo:
                            </Text>
                        </Section>
                        ...
                        <Section className="px-8 mt-8">
                            <Text className="text-sm">
                                Caso o botão não funcione, você também pode
                                copiar e colar o link abaixo em seu navegador:{" "}
                                <Link href={link}>Link de Verificação</Link>
                            </Text>
                        </Section>
                        <Section className="px-8 text-zinc-500">
                            <Text className="text-xs text-center">
                                Se você não criou uma conta em nossa plataforma,
                                por favor, ignore este e-mail.
                            </Text>
                            <Text className="text-xs text-gray-500 mt-4">
                                Se tiver alguma dúvida, entre em contato com
                                nossa equipe de suporte através do e-mail{" "}
